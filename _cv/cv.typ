...
#show heading.where(level: 1): it => [
  #v(12pt, weak: true)
  #text(size: 11pt, weight: "semibold")[#smallcaps(it.body)]
  #v(-4pt)
...
#entry([*Student engagement, Monetary Policy Department, Norges Bank*], [2017--2019], body: [Part-time alongside the MA. Contributed to the Monetary Policy Report in the unit for analysis and forecasting of the Norwegian economy.])

#entry([*Coordinator and speaker, Confederation of Norwegian Enterprise (NHO)*], [2015--2017], body: [Part-time. Delivered NHO's educational programmes on Norwegian business and Norway's relationship with the EU.])

#entry([*Journalist*, Vårt Land and Universitas], [2016--2017], body: [Politics and world desk (Vårt Land, 2017); news desk (Universitas, 2016--2017).])

= Teaching

#entry([*Seminar teaching, University of Oslo*], [2017, 2021--present], body: [Master's level: macroeconomics, monetary policy, econometrics, labor economics, and corporate governance. Bachelor's level: Macroeconomic Analysis, and the bachelor thesis course in International Studies.])
